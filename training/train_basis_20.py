...
for epoch in range(400):
    ...
    with torch.no_grad():
        ...
        if eval_loss <  best_eval_loss:
            ...
            torch.save(basisNet.state_dict(), '%s/basis_model_best_20.pth' % (outf))

        train_losses.append(train_loss)
        eval_losses.append(eval_loss)

        # Logging losses
        np.save(outf+'/train_losses_basis_20.npy',train_losses)
        np.save(outf+'/eval_losses_basis_20.npy',eval_losses)
